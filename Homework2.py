...
dict_Coefficient = { 'Vision':     [1, 0.98, 0.89, 0.84, 0.75, 0.61],
...
def get_utilityscore (vision, hearing, speech, ambulation, dexterity, emotion, cognition, pain):
    ...
    if not vision in [1,2,3,4,5,6]:
        raise ValueError ('Vision level can only take values 1,2,3,4,5, or 6')
    ...
    score=0
    score += Coefficient * (dict_Coefficient['Vision'][vision-1] * dict_Coefficient['Hearing'][hearing-1] * dict_Coefficient['Speech'][speech-1] * dict_Coefficient['Ambulation'][ambulation-1] * dict_Coefficient['Dexterity'][dexterity-1] * dict_Coefficient['Emotion'][emotion-1] *dict_Coefficient['Cognition'][cognition-1] * dict_Coefficient['Pain'][pain-1]) - Constant
